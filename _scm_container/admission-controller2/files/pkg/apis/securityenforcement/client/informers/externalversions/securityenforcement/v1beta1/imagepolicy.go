...
import (
	...
	versioned "admission-controller2/pkg/apis/securityenforcement/client/clientset/versioned"
	internalinterfaces "admission-controller2/pkg/apis/securityenforcement/client/informers/externalversions/internalinterfaces"
	v1beta1 "admission-controller2/pkg/apis/securityenforcement/client/listers/securityenforcement/v1beta1"
	securityenforcement_v1beta1 "admission-controller2/pkg/apis/securityenforcement/v1beta1"
...
func NewFilteredImagePolicyInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&securityenforcement_v1beta1.ImagePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imagePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&securityenforcement_v1beta1.ImagePolicy{}, f.defaultInformer)
}
