...
import (
	"admission-controller2/pkg/apis/securityenforcement/client/clientset/versioned/scheme"
	v1beta1 "admission-controller2/pkg/apis/securityenforcement/v1beta1"
	serializer "k8s.io/apimachinery/pkg/runtime/serializer"
	rest "k8s.io/client-go/rest"
)

type SecurityenforcementV1beta1Interface interface {
...
func NewForConfig(c *rest.Config) (*SecurityenforcementV1beta1Client, error) {
	...
	return &SecurityenforcementV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new SecurityenforcementV1beta1Client for the given config and
...
func New(c rest.Interface) *SecurityenforcementV1beta1Client {
	return &SecurityenforcementV1beta1Client{c}
}
